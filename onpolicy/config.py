...
def get_config():
    ...
    Save & Log parameters:
        ...
        --use_wandb
            [for wandb usage], by default True, will log date to wandb server. or else will use tensorboard to log data.
        --verbose
            by default, do not print verbose information. If set, print verbose information.
    ...
    parser.add_argument(
        ...
        action="store_true",
        default=False,
        help="by default, do not print verbose information. If set, print verbose information.",
    )
    ...
    parser.add_argument(
        ...
        type=float,
        default=5e-4,
        help="learning rate (default: 5e-4 but I use 7e-4 because the original paper uses 7e-4)",
    )
    parser.add_argument(
        "--critic_lr",
        type=float,
        default=5e-4,
        help="critic learning rate (default: 5e-4) but I use 1e-4 because the original paper uses 1e-3",
    )
    parser.add_argument(
        "--opti_eps",
        type=float,
    ...
    parser.add_argument(
        ...
        type=int,
        default=1,
        help="time between contiunous twice models saving.",
    )

    parser.add_argument(
        "--save_every_x_updates",
        type=int,
        default=1000,
        help="save model every x updates (default: 100)",
    )
